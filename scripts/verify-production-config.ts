...
const SECRET_PUBLIC_NAME_PATTERN =
  /(?:SECRET|PRIVATE|PASSWORD|PASSWD|MNEMONIC|DATABASE|REDIS|JWT|RPC|WEBHOOK|SIGNING|PINATA|API[_-]?KEY|ACCESS[_-]?KEY|(?:^|_)AUTH(?:_|$)|AUTHORIZATION|AUTHENTICATION|CREDENTIAL|TOKEN)/i;
