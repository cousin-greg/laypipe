...
contract PipedogBuybackBurner is Ownable2Step, ReentrancyGuard, IUniswapV3SwapCallback {
    ...
    event Burned(address indexed caller, uint256 ethSpent, uint256 pipedogBurned, uint256 bounty);
    ...
    /// @dev PIPEDOG has no burn() — supply reduction is not possible at the
    ...
    function burn() external nonReentrant returns (uint256 pipedogBurned) {
        ...
        emit Burned(msg.sender, ethSpent, pipedogBurned, bounty);
    }
